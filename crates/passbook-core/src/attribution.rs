...
pub fn compute_gas_payment(i: GasInput) -> GasPaymentRow {
    ...
    GasPaymentRow {
        ...
        address: i.tx_from,
        gas_used: i.gas_used,
        effective_gas_price: i.effective_gas_price,
        l2_fee_wei: l2,
        l1_fee_wei: i.l1_fee_wei,
        total_wei: total,
    }
}
...
mod tests {
    ...
    fn gas_payment_includes_l1_when_present() {
        let g = compute_gas_payment(GasInput {
            ...
            tx_from: Address::repeat_byte(0xaa),
            gas_used: 21000,
            effective_gas_price: 1_000_000_000u128,
    ...
    fn frames_attribute_in_and_out_for_watched() {
        ...
        let (inb, outb): (Vec<_>, Vec<_>) = rows
            .iter()
            .partition(|r| r.direction == crate::model::Direction::In);
