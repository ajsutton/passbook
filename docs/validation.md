...
- **Honest limitations, stated plainly:**
  ...
  - **Resume-after-fix** is met by the retry-until-success +
    ...
    deterministic fixture property, not a runtime toggle, so a clear-in-place
