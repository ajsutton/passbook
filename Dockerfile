...
RUN --mount=type=cache,target=/usr/local/cargo/registry \
    ...
    cargo build --release --locked -p reth-passbook -p op-reth-passbook --features reth-passbook/jemalloc,op-reth-passbook/jemalloc,reth-passbook/asm-keccak,op-reth-passbook/asm-keccak
